...
Here we give a quick start guide on how to get your first example running with qnet. After completing the
...
of commands that are built into hosts, see the [Design Overview section](https://tqsd.github.io/qnet/design.html).
