...
The key components are qnet are the following: Host, Protocols, and  Network. Each component represents a layer in
...
a set of features that can be used to write network applications. Users of qnet will interact mostly with the Host
components.
...
The Network component is the key part of qnet. It is responsible for routing and generating distant entanglement
when it is needed.
