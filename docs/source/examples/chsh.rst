...
In this example, we show how to play the CHSH game with qnet. The CHSH game is an example where
...
such operations. qnet supports, at the moment, three backends for qubits, namely, SimulaQron, ProjectQ, and a
